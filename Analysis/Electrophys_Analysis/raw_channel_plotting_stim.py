# Plot the raw data during one trial with stimulation (and cleaned PARRM data)
...
# Add bipolar ECoG channel
"""new_ch = raw.get_data("ECOG_R_02_SMC_AT") - raw.get_data("ECOG_R_03_SMC_AT")
u.add_new_channel(raw, new_ch, "ECOG_bipolar_stim", type="ecog")"""
...
channel_names = ["ECOG_R_2_CAR_raw", 'ECOG_R_2_CAR']
...
tmin = int(0.5 * sfreq)
tmax = int(2 * sfreq)
names = ["RAW ECoG 2", "PARRM Cleaned \nECoG 2"]
