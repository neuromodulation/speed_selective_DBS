...
# Compute tfr
tfr = epochs.compute_tfr(method="multitaper", freqs=frequencies, picks=target_chan_names, average=False, n_cycles=7)#frequencies/2)
# Crop tfr
...
plt.savefig(f"../../../Figures/{dir_name}/{plot_name}_{sub}_{target_chan_name}.pdf",
        format="pdf", bbox_inches="tight", transparent=True)
plt.savefig(f"../../../Figures/{dir_name}/{plot_name}_{sub}_{target_chan_name}.png",
