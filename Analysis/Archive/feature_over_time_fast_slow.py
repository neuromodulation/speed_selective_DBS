...
if plot_individual:
    for i in range(n_datasets):
        ...
        plt.title(f"dataset_{names[i]}_{feature_name}_{med}")
        # Save figure on individual basis
        plt.savefig(f"../../Figures/dataset_{names[i]}_{feature_name}_{med}.png", format="png", bbox_inches="tight")
        #plt.close()
...
plt.savefig(f"../../Figures/over_time_{feature_name}_{med}.svg", format="svg", bbox_inches="tight", transparent=True)
