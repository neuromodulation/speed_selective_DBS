# Extract power in different frequency bands for all trials and safe in matrix for further analysis
...
# Load files and create one file for each band and contact
